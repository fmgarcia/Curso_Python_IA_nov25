...
"""
Random Forest Classifier para detección de tumores
...
MODEL_PATH = os.path.join(os.path.dirname(__file__), '..', 'weights', 'random_forest.joblib')
FEATURE_NAMES_PATH = os.path.join(os.path.dirname(__file__), '..', 'weights', 'feature_names.joblib')
ACCURACY_PATH = os.path.join(os.path.dirname(__file__), '..', 'weights', 'random_forest_accuracy.json')
...
def load_training_data():
    ...
    Usa dataset personalizado si existe, sino usa el original.
    """
...
def train():
    """
    Entrena el modelo Random Forest y guarda los pesos
    Returns:
    ...
    # Guardar accuracy en archivo JSON
    ...
    return {
        ...
        "message": f"Modelo Random Forest entrenado y guardado correctamente{dataset_msg}"
    }
...
def predict(features: dict):
    ...
    if not os.path.exists(MODEL_PATH):
        raise FileNotFoundError("El modelo no ha sido entrenado. Ejecute /train/random_forest primero.")
...
def get_accuracy():
    """Obtiene el accuracy del modelo entrenado"""
